...
const teamData: Member[] = [
  { id: 48, name: 'Alice Johnson', p1Critical: 30, p2High: 8, p3Moderate: 0, p4Low: 10, avgResolvedTime: '132 Weeks', timeTrend: 'up' },
  { id: 40, name: 'Jamie Smith', p1Critical: 25, p2High: 15, p3Moderate: 0, p4Low: 0, avgResolvedTime: '127 Weeks', timeTrend: 'down' },
  { id: 32, name: 'Michael Smith', p1Critical: 8, p2High: 4, p3Moderate: 7, p4Low: 13, avgResolvedTime: '92 Weeks', timeTrend: 'down' },
  { id: 28, name: 'April Aurora', p1Critical: 14, p2High: 4, p3Moderate: 7, p4Low: 3, avgResolvedTime: '62 Weeks', timeTrend: 'down' },
  { id: 40, name: 'Jamie Smith', p1Critical: 25, p2High: 15, p3Moderate: 0, p4Low: 0, avgResolvedTime: '127 Weeks', timeTrend: 'down' },
...
const TeamMemberCard = ({ member }: { member: Member }) => (
  <div className="member-card">
    ...
    <div className="avg-resolved-time">
      ...
      <span className={`avg-value ${member.timeTrend === 'up' ? 'trend-up' : 'trend-down'}`}>
        {member.avgResolvedTime}
        {/* Using simple text/symbols for the trend icon, corresponding to the CSS color */}
        <span className="trend-icon">{member.timeTrend === 'up' ? <FaArrowCircleDown fill="#C10041" height="15px" width='15px' />
    ...
    <div className="team-portfolio-container">
      ...
      <footer className="portfolio-footer">
        ...
        <div className="pagination">
          ...
          <button style={{ borderRadius: '6px 0 0 6px', border: ' 1px solid #33303111' }} className="page-control" disabled>
           <img src={forward}/><img src={forward}/>
          </button>
          <button style={{ border: ' 1px solid #33303111' }} className="page-control" disabled><img src={forward}/>
          </button>
          <button style={{ border: ' 1px solid #33303111' }} className="page-control"><img src={backward}/>
          </button>
          <button style={{ borderRadius: '0 6px 6px 0', border: ' 1px solid #33303111' }} className="page-control"><img src={backward}/><img src={backward}/>
          </button>
        </div>
      </footer>
    </div>
